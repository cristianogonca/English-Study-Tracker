...
export const GUIA_BASE_12_MESES = [
  ...
  },
  {
    ...
    writing: [
      "✍️ Ensaios argumentativos",
      "🎯 Meta: 300+ palavras"
    ],
    checkFinal: [
      "Usar estruturas avançadas naturalmente",
      "Vocabulário: ~1400 palavras"
    ]
  },
  {
    mes: 10,
    titulo: "Conversação Natural",
    objetivos: [
      "Falar com fluidez natural",
      "Entender diferentes sotaques",
      "Vocabulário: 1600+ palavras"
    ],
    gramatica: [
      "Revisão de todos os tempos verbais",
      "Collocations",
      "Natural expressions",
      "Linking words advanced"
    ],
    vocabulario: [
      "Slang e expressões coloquiais",
      "Idioms contextualizados",
      "Cultural references"
    ],
    listening: [
      "📻 Filmes e séries",
    ...
    checkFinal: [
      "Conversar naturalmente por 30+ minutos",
      "Vocabulário: ~1600 palavras"
    ]
  },
  {
    ...
    writing: [
      "✍️ Artigos profissionais",
      "🎯 Meta: 500+ palavras"
    ],
    checkFinal: [
      "Atuar em ambientes profissionais avançados",
      "Vocabulário: ~1800 palavras"
    ]
  },
  {
    ...
    titulo: "Maestria",
    objetivos: [
      "Consolidar tudo aprendido",
      "Atingir fluência completa",
      "Vocabulário: 2000+ palavras"
    ],
    gramatica: [
      "Revisão completa de 12 meses",
      "Nuances e sutilezas",
      "Advanced grammar consolidation"
    ],
    vocabulario: [
      "Vocabulário completo para comunicação total",
      "Expressões culturais",
      "Multilevel vocabulary"
    ],
    listening: [
      "📻 Qualquer conteúdo nativo",
      "📻 Compreensão 90%+"
    ],
    speaking: [
      "🎤 Fluência natural",
    ...
    reading: [
      ...
      "📖 Leitura sem dicionário"
    ],
    writing: [
      "✍️ Qualquer gênero textual",
      "🎯 Meta: Produção livre"
    ],
    checkFinal: [
      "✨ Inglês fluente completo",
      "✨ Nível B2/C1 (CEFR)",
      "✨ Vocabulário: 2000+ palavras ativas",
      "✨ Compreensão: 90%+",
      "✨ Pronto para certificações internacionais"
    ]
  }
];
